# Informe – Semana 13 (Sprint 1 – Hasta Modelo Baseline)
...
- Análisis de umbrales óptimos para minimizar falsos positivos
...
- **Licencia:** CC BY 4.0
- **URL:** [Dataset en Roboflow](https://universe.roboflow.com/diabetic-prediction-by-tongue-image-classification/anemia-detection-u0dhr-rzmdb)
...
### Entregable
- ✅ **Notebook ejecutable:** [cp_v1.ipynb](cp_v1.ipynb)
...
**Dataset de Entrenamiento (2,391 imágenes):**
- Se identificó desbalance significativo entre las clases
- Cálculo de ratio de desbalance: `max(class_counts) / min(class_counts)`
...
### Entregable
- ✅ **Sección EDA integrada en notebook** [cp_v1.ipynb](cp_v1.ipynb)
...
**Entregable:**
- ✅ **Código de entrenamiento:** Fase 3 en [cp_v1.ipynb](cp_v1.ipynb) (líneas ~156-241)
...
**Entregable:**
- ✅ **Código de entrenamiento:** Fase 5 en [cp_v1.ipynb](cp_v1.ipynb) (líneas ~703-1085)
...
- **Umbrales asimétricos:** Anemia=0.75, Normal=0.40
...
- Umbrales asimétricos iniciales (ANEMIA=75%, NORMAL=40%) clasificaban casos reales de anemia como "Incertidumbre"
- Test con 4 imágenes de anemia confirmadas: todas mostraban probabilidades entre 63-71%, por debajo del umbral del 75%
...
- ✅ **Tabla de resultados:** [cp_v1.ipynb](cp_v1.ipynb) Celdas 30-37
...
1. **Arquitectura Dual Robusta:** Sistema detector+clasificador con 88.24% accuracy
2. **Corrección de Sesgo Exitosa:** 100% → 2.9% falsos positivos en normales
3. **Calibración de Umbrales Óptima:** Análisis ROC + validación iterativa → 100% detección anemias
4. **Sistema Adaptativo:** Ajuste de umbrales de 75%→60% basado en datos reales
5. **Interfaz Intuitiva:** Fácil de usar sin conocimientos técnicos, auto-detección de función optimizada
6. **Documentación Completa:** Código comentado y reproducible con guía de ejecución paso a paso
7. **Validación Exhaustiva:** 97.1% resultados aceptables (33/34 normales) + 100% anemias detectadas (4/4)

#### ⚠️ Puntos a Mejorar

1. **Dataset Limitado:** Test set pequeño (68 imágenes) - Ampliar a 200+
2. **Zona de Incertidumbre:** 20% de zona gris (60%-40%) - Explorar técnicas de calibración adicionales
3. **Validación Clínica:** Necesita comparación con hemogramas reales para confirmar diagnósticos
4. **Explicabilidad:** Implementar Grad-CAM para interpretabilidad de decisiones del clasificador
5. **Generalización:** Validar con imágenes de diferentes dispositivos y condiciones de iluminación
...
**Fin del Informe Sprint 1**

*Generado: Enero 2026*  
*Responsables: John Rivera, Manuel Cochachin*
